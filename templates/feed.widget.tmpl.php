...
?>
			<cite><span class="timeago" title="<?= wfTimestamp(TS_ISO_8601, $row['timestamp']) ?>"><?php print ActivityFeedRenderer::formatTimestamp( $row['timestamp'] ); ?></span> <?php print wfMessage( "myhome-feed-by", FeedRenderer::getUserPageLink( $row ) )->text() ?></cite>
		</li>
<?php
	}
?>
